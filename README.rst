========================================
Lego Exchanger backend API
========================================

This is backend API for the Lego Exchanger Project.
...
::
    ...
    $ pip install chalice
    $ git clone https://github.com/rastaturin/LegoXApi
    $ cd LegoXApi
    $ chalice local --port=5000
::

Send requests to the endpoint http://localhost:5000
